...
def help_user(bot, update):
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ Support ⭕️", url="https://t.me/Housefull_links")]]),
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ Contact Dev ⭕️", url="https://t.me/saminsumesh")]]),
        parse_mode="html",
